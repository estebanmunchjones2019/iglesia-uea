...
export class NosotrosComponent implements OnInit {
  ...
  content1: string = `La biblia fue inspirada por Dios en su totalidad.
  ...
  content4: string = `El hijo de Dios se encarnó en la persona de Jesús,
   ...
   fue 100% Dios y 100% hombre, murió en una cruz y resucitó al tercer
  ...
  content5: string = `En Adán, toda la humanidad participó del pecado original y,
   por consecuencia, todo hombre está muerto espiritualmente y separado de Dios,
  ...
  Padre, rota por nuestros pecados. Ahora, al creer en Jesucristo y en su obra, tenemos`;
